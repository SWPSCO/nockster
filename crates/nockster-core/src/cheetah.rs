...
#[cfg(feature = "std")]
pub use tx_types::crypto::{cheetah_pub_from_sk, schnorr_sign_digest, CryptoError, ExtendedKey};
...
pub fn master_from_seed(seed64: &[u8]) -> ([u8; 32], [u8; 32]) {
    let ext = tx_types::crypto::slip10::master_from_seed(seed64).expect("master_from_seed");
