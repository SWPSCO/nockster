...
pub fn run(port: &str, baud: u32, draft_path: &str, out_opt: Option<&str>, slot: u8) -> Result<()> {
    ...
    let out_bytes = send_blob_and_recv_outbound(&mut *sp, 0xD001, FragKind::SignDraft, &draft_bytes)
