...
pub const COLOR_BACKGROUND: Rgb565 = Rgb565::new(2, 4, 8); // deep indigo
...
pub const COLOR_TEXT: Rgb565 = Rgb565::new(29, 58, 31); // warm white
pub const COLOR_TEXT_SUBTLE: Rgb565 = Rgb565::new(18, 32, 21);

pub const COLOR_ACCENT_PRIMARY: Rgb565 = Rgb565::new(18, 44, 24); // teal
pub const COLOR_ACCENT_PRIMARY_LIGHT: Rgb565 = Rgb565::new(23, 54, 28);
pub const COLOR_ACCENT_PRIMARY_DARK: Rgb565 = Rgb565::new(10, 24, 15);

pub const COLOR_ACCENT_SECONDARY: Rgb565 = Rgb565::new(26, 20, 30); // violet
...
pub const COLOR_KEYPAD_ACTIVE: Rgb565 = COLOR_ACCENT_PRIMARY_LIGHT;
