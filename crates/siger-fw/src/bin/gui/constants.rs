...
pub const COLOR_ACCENT_WARNING: Rgb565 = Rgb565::new(31, 18, 10);

pub const COLOR_BUTTON: Rgb565 = COLOR_SURFACE_LOW;
pub const COLOR_BUTTON_BORDER: Rgb565 = COLOR_DIVIDER;
pub const COLOR_BUTTON_ACTIVE: Rgb565 = COLOR_ACCENT_PRIMARY_LIGHT;
...
pub const COLOR_CONFIRM_APPROVE: Rgb565 = COLOR_BTN_PRIMARY_BASE;
pub const COLOR_CONFIRM_APPROVE_ACTIVE: Rgb565 = COLOR_BTN_PRIMARY_LIGHT;
pub const COLOR_CONFIRM_REJECT: Rgb565 = COLOR_BTN_SECONDARY_BASE;
pub const COLOR_CONFIRM_REJECT_ACTIVE: Rgb565 = COLOR_BTN_SECONDARY_LIGHT;
