...
const MDS: [[u64; 16]; 16] = [
    ...
    [
        ...
        10400600, 20058300, 37442160,
    ],
    [
        1, 15, 120, 680, 3060, 11628, 38760, 116280, 319770, 817190, 1961256, 4457400, 9657700,
        20058300, 40116600, 77558760,
    ],
    [
        1, 16, 136, 816, 3876, 15504, 54264, 170544, 490314, 1307504, 3268760, 7726160, 17383860,
        37442160, 77558760, 155117520,
    ],
];
