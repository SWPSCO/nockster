...
7. Review and scroll through all required transaction details on the Nockster screen.
8. After the complete review has been viewed, hold **Approve** to sign, or reject if anything looks wrong.
...
Check the recipient, amount, fee, and any lock or refund warnings shown during review. **Approve** remains unavailable until the required review pages have been viewed. The host computer can ask for a signature, but the device approval is the important step.
